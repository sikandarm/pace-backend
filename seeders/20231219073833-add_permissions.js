...
module.exports = {
  async up(queryInterface, Sequelize) {
    const permissionsData = [
      ...
      { name: "Delete_Contact", slug: "delete_contact", isActive: 1 },
      { name: "Edit_Contact", slug: "edit_contact", isActive: 1 },
      { name: "Add_Purchase", slug: "add_purchase", isActive: 1 },
      { name: "Edit_Purchase", slug: "edit_purchase", isActive: 1 },
      { name: "Delete_Purchase", slug: "delete_purchase", isActive: 1 },
      {
        name: "View PurchaseDetails",
        slug: "view_purchasedetails",
        isActive: 1,
      },
      { name: "Add PurchaseOrder Item", slug: "add_purchaseitem", isActive: 1 },
      ...
      { name: "Add FabricatedItems", slug: "add_fabricateditems", isActive: 1 },
      {
        name: "Update FabricatedItems",
        slug: "update_fabricateditems",
        isActive: 1,
      },
      ...
      { name: "Download_Diagram", slug: "download_diagram", isActive: 1 },
      { name: "Make_Call", slug: "make_call", isActive: 1 },
    ];
